...
public final class MergerTest {
	...
	public void testMergeMap() {
		...
		final Map<Integer, String> mergedMap = unit.merge(map, gson -> gson.fromJson("{\"3\":\"three\",\"4\":\"four\"}", mapType(Integer.class, String.class)));
	...
	public void testMergeMapWithNestedMap() {
		...
		final IMerger unit = getMerger(gson);
		final Map<Integer, String> mergedMap = unit.merge(map, gson -> gson.fromJson("{\"1\":null,\"2\":two,\"3\":\"three\",\"4\":\"four\",\"5\":{}}", mapType(Integer.class, Object.class)));
		assertThat(mergedMap, sameInstance(map));
